...
*/
#define emailSenderAccount    "r.ingles92@gmail.com"                        //Introduce tu dirección de e-mail
#define emailSenderPassword   "Sharingan-92"                                //Introduce tu contraseña de la dirección e-mail 
#define emailRecipient        "mireya.mara88@gmail.com"                     //Introduce el e-mail de la persona a la que le envias el paquete
...
const char* ssid = "MOVISTAR_FFCE";//Enter your SSID here
const char* password = "Xx992BBfAJVX82Z328HQ"; //Enter your Passwork here
...
void MailEntrega() 
{
  ...
  /* Introducir el formato del texto */
  smtpData2.setMessage("<div style=\"color:#2f4468;\"><h1>Estimado señor/a su paquete ha sido enviado con exito </h1><p>- Sent from ESP32 board</p></div>", true);
...
void setup()  
{
  ...
  //pinMode(flash, OUTPUT);           //Define pin para  flash
